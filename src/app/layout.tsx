...
const siteConfig = {
  ...
  title: "TheOkeJacobs | Award-Winning Nigerian Photographer UK | Wedding & Portrait Photography",
  description: "Award-winning Nigerian photographer based in UK. Specializing in weddings, portraits, and lifestyle photography across London, Birmingham & Manchester. 10+ years experience capturing Nigerian, African & multicultural celebrations with cultural sensitivity and artistic excellence.",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@id": siteConfig.url,
              url: siteConfig.url,
              telephone: "+44-XXX-XXX-XXXX", // Add your phone
              // priceRange: "££-£££",
              address: {
                "@type": "PostalAddress",
                ...
                itemListElement: [
                  {
                    ...
                    itemOffered: {
                      ...
                      description: "Full-day wedding photography coverage including traditional Nigerian, African, and multicultural weddings",
                    },
                  },
                  {
                    "@type": "Offer",
                    itemOffered: {
                      ...
                      description: "Professional portrait sessions for individuals, families, and personal branding",
                    },
                  },
                  {
                    "@type": "Offer",
                  ...
                  },
                  {
                    ...
                    itemOffered: {
                      ...
                      description: "Cultural celebration and naming ceremony photography",
                    },
                  },
                ],
              },
